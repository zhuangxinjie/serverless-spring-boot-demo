package com.alauda.serverlessspringbootdemo.util;
...
public class NameUtil {
    ...
    public static UserInfo getUserInfo() {
        ...
        info.setName(getChineseName());
        info.setSex(name_sex);
        info.setRoad(getRoad());
        info.setTel(getTel());
        info.setEmail(getEmail(6,9));
        return info;
    }
